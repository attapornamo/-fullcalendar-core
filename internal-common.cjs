...
function flushSync(runBeforeFlush) {
  ...
  preact__namespace.render(
    preact__namespace.createElement(FakeComponent, {}),
    ...
    return preact.createElement(
      ...
      (InnerContainer) =>
        preact.createElement(
          ...
          !dayMeta.isDisabled &&
            preact.createElement(InnerContainer, {
              elTag: 'a',
    ...
    return preact.createElement(
      ...
      (nowDate, todayRange) =>
        preact.createElement(
          ...
          dates.map((date) =>
            datesRepDistinctDays
              ? preact.createElement(TableDateCell, {
  ...
  render() {
    ...
    return preact.createElement(
      ...
      Boolean(!isBuggy && headSectionNodes.length) &&
        preact.createElement('thead', roleAttrs, ...headSectionNodes),
      Boolean(!isBuggy && bodySectionNodes.length) &&
        preact.createElement('tbody', roleAttrs, ...bodySectionNodes),
      Boolean(!isBuggy && footSectionNodes.length) &&
        preact.createElement('tfoot', roleAttrs, ...footSectionNodes),
      isBuggy &&
        preact.createElement(
          'tbody',
          roleAttrs,
...
const NowIndicatorContainer = (props) =>
  preact.createElement(ViewContextType.Consumer, null, (context) => {
    let { options } = context;
    let renderProps = {
      isAxis: props.isAxis,
