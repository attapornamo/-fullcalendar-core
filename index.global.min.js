...
var FullCalendar = (function (e) {
  ...
  const Ot = Ie({ year: 'numeric', month: 'long', day: 'numeric' }),
    It = Ie({ week: 'long' });
  function Mt(e, t, n = 'day', r = !0) {
    const { dateEnv: i, options: o, calendarApi: s } = e;
    let a = i.format(t, 'week' === n ? It : Ot);
    if (o.navLinks) {
      let e = i.toDate(t);
      const l = (e) => {
        let r =
  ...
  function En(e, t, n, r, i, o, s, a, l, c) {
    ...
    for (n.__e = g, u = b; u--; )
      null != v[u] &&
        ...
        On(v[u], v[u]));
    if (m) for (u = 0; u < m.length; u++) xn(m[u], m[++u], m[++u]);
  }
  function Dn(e, t, n) {
  ...
  function On(e, t, n) {
    ...
    if ((r = e.__k))
      for (i = 0; i < r.length; i++)
        r[i] && On(r[i], t, n || 'function' != typeof e.type);
    ...
    constructor() {
      super(...arguments),
        ...
        (this.handleEl = (e) => {
          ...
          (t.customRenderingReplaces && Ei(n, t)) || this.updateElRef(e);
        }),
        (this.updateElRef = (e) => {
  ...
  class xi extends Sr {
    render() {
      ...
      return ln(
        ...
        {
          elTag: 'th',
          elClasses: [Ai, ...xt(s, n), ...(e.extraClassNames || [])],
          elAttrs: Object.assign(
  ...
  function Xi(e) {
    let t = u(e, '.fc-scrollgrid-shrink'),
      n = 0;
    for (let e of t) n = Math.max(n, O(e));
    return Math.ceil(n);
  }
  function Ki(e, t) {
  ...
  class ho extends Sr {
    ...
    render() {
      ...
      return ln(
        Si,
        Object.assign({}, e, {
          elClasses: [...xt(r, t.theme), ...(e.elClasses || [])],
          elAttrs: Object.assign(
  ...
  class Ro {
    ...
    select(e, t) {
      ...
      i &&
        (this.dispatch({ type: 'SELECT_DATES', selection: i }), Or(i, null, r));
    }
    unselect(e) {
      let t = this.getCurrentData();
      t.dateSelection &&
  ...
  var xo = {
    ...
    allowSelection: function (e) {
      (e.style.userSelect = ''),
        ...
        e.removeEventListener('selectstart', v);
    },
      ...
      handleInvalidInsertion(e, t, n) {
        if (this.allowReslicing && e.touchingEntry) {
          const r = Object.assign(Object.assign({}, t), {
            span: di(t.span, e.touchingEntry.span),
          });
  ...
  function vs(e) {
    return new (e.dateProfileGeneratorClass || xr)(e);
  }
  function bs(e, t, n) {
    return new cs(e, t, n);
  }
          ...
          i && u.push(n.getClass('buttonActive')),
            r.push(
              ln(
                ...
                a || (l ? ln('span', { className: l, role: 'img' }) : '')
              )
            );
        }
      }
    ...
    (e.Calendar = class extends Ro {
      constructor(e, t = {}) {
        super(),
          ...
          (function (e) {
            e.isConnected && e.getRootNode && i(e.getRootNode());
          })(e),
          (this.el = e),
